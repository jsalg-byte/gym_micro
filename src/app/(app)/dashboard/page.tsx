    ...
    <main className="space-y-4">
      <section className="panel p-4">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Core MVP modules are active: username auth, workout plans by day, sessions, nutrition with barcode autofill,
          Redis, and progress photos.
        </p>
      </section>
      <section className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <article className="panel p-4">
          <p className="text-xs uppercase tracking-wide text-slate-500">Workout Plans</p>
